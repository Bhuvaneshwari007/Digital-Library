                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="newbooks.php" class="nav-item nav-link">Discover new Books</a>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="subscribeuser.php" class="dropdown-item">Buy Your Subscription Plan</a>
                                </div>
                            </div>
                            <a href="mysubscription.php" class="nav-item nav-link">MySubscriptions</a>
                        </div>
                    ...
                    <div class="col-md-12 col-lg-7">
                        ...
                        <div class="container-fluid py-5 mb-5 hero-header">
                            ...
                            <div class="position-relative mx-auto">
                                <button id="logoutButton" type="button" class="btn btn-primary border-2 border-secondary py-3 px-4 rounded-pill text-white h-100">Log out</button>
